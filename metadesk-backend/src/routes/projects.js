...
router.post('/:id/members', requirePermission('manageProjects'), addMember)
router.delete('/:id/members/:userId', requirePermission('manageProjects'), removeMember)
router.put('/:id/members/:userId/permission', requirePermission('manageProjects'), updateMemberPermission)
